...
*/
package wayne.me.androidodemo.notification;
...
public class NotificationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new MainUi(findViewById(R.id.activity_notification));
    }
    ...
    public void sendNotification(int id, String title) {
        ...
        switch (id) {
            case NOTI_PRIMARY1:
                nb = mNotifyHelper.getNotification1(title, getString(R.string.primary1_body));
                break;

            case NOTI_PRIMARY2:
                nb = mNotifyHelper.getNotification1(title, getString(R.string.primary2_body));
                break;

            case NOTI_SECONDARY1:
                nb = mNotifyHelper.getNotification2(title, getString(R.string.secondary1_body));
                break;

            case NOTI_SECONDARY2:
                nb = mNotifyHelper.getNotification2(title, getString(R.string.secondary2_body));
                break;
        }
        if (nb != null) {
            mNotifyHelper.notify(id, nb);
        }
    }
     ...
     * separate.)
     */
    private class MainUi implements View.OnClickListener {
        final TextView mTitlePrimary;
        final TextView mTitleSecondary;

        private MainUi(View root) {
            mTitlePrimary = root.findViewById(R.id.main_primary_title);
            ...
            mTitleSecondary = root.findViewById(R.id.main_secondary_title);
        ...
        private String getTitlePrimaryText() {
            if (mTitlePrimary != null) {
                return mTitlePrimary.getText().toString();
            }
            return "";
        }
        ...
        private String getTitleSecondaryText() {
            if (mTitlePrimary != null) {
                return mTitleSecondary.getText().toString();
            }
            return "";
        }
